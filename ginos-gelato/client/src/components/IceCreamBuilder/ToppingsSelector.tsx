        ...
        <div className="gelato-card">
            <div className="flex justify-between items-center mb-6">
                ...
                {selectedToppings.length > 0 && (
                    <div className="text-sm text-gray-600 dark:text-gray-300 bg-gradient-to-r from-yellow-100 to-orange-100 dark:from-yellow-900/40 dark:to-orange-900/40 px-4 py-2 rounded-full">
            ...
            {selectedToppings.length === 0 && (
                <div className="mt-4 p-4 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/30 dark:to-purple-900/30 rounded-lg text-center">
