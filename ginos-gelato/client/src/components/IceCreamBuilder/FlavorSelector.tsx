  ...
  return (
    <div className="gelato-card">
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="text-sm text-gray-600 dark:text-gray-300 bg-gradient-to-r from-pink-100 to-orange-100 dark:from-pink-900/40 dark:to-orange-900/40 px-4 py-2 rounded-full">
      ...
      {selectedFlavors.length >= 3 && (
        <div className="mt-4 p-3 bg-gradient-to-r from-orange-100 to-yellow-100 dark:from-orange-900/30 dark:to-yellow-900/30 rounded-lg text-center">
          <p className="text-orange-700 dark:text-orange-300 font-medium">🎯 Perfect! You've selected the maximum 3 flavors.</p>
        </div>
      )}
    </div>
  );
