    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-pink-50 via-blue-50 to-yellow-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 relative overflow-hidden transition-colors duration-300">
            ...
            <div className="gelato-container relative z-10">
                ...
                {cartItems.length === 0 ? (
                    <div className="gelato-card text-center bg-gradient-to-br from-white to-blue-50 dark:from-gray-800 dark:to-gray-700 max-w-md mx-auto">
                        <div className="text-6xl mb-4">🛒</div>
                        <h2 className="text-2xl font-semibold text-gray-700 dark:text-gray-200 mb-4">Your cart is empty!</h2>
                        <p className="text-gray-600 dark:text-gray-400 mb-6">Ready to create some delicious ice cream?</p>
                        <Link to="/builder">
                    ...
                    <div className="grid lg:grid-cols-3 gap-8">
                        ...
                        <div className="space-y-6">
                            ...
                            {/* Special Offers */}
                            <div className="gelato-card bg-gradient-to-r from-yellow-100 to-orange-100 dark:from-yellow-900/30 dark:to-orange-900/20">
