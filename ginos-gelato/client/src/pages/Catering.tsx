...
const Catering: React.FC = () => {
    return (
        <div className="min-h-screen bg-gradient-to-br from-pink-50 via-purple-50 to-yellow-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 px-6 py-12">
            <div className="container mx-auto max-w-5xl">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                    {packages.map((pkg) => (
                        <div key={pkg.title} className="gelato-card bg-gradient-to-br from-white to-purple-50 dark:from-gray-800 dark:to-purple-900/20 text-center">
                ...
                <div className="gelato-card mt-8 bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-yellow-900/30 dark:to-orange-900/30">
