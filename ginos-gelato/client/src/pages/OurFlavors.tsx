...
const OurFlavors: React.FC = () => {
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-pink-50 to-yellow-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 px-6 py-12 transition-colors duration-300">
            <div className="container mx-auto max-w-5xl">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                    {flavorFamilies.map((family) => (
                        <div key={family.title} className={`gelato-card bg-gradient-to-br ${family.color} dark:from-gray-700 dark:to-gray-800`}>
                            <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-4">{family.title}</h2>
                ...
                <div className="gelato-card mt-8 bg-gradient-to-r from-green-50 to-teal-50 dark:from-green-900/30 dark:to-gray-800">
                    <h3 className="text-2xl font-semibold text-gray-800 dark:text-gray-100 mb-3">Seasonal Drops</h3>
