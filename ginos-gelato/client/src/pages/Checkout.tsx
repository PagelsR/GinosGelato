...
const Checkout: React.FC = () => {
    ...
    const renderPaymentStep = () => (
        <div className="grid lg:grid-cols-3 gap-8">
            ...
            {/* Order Summary */}
            <div>
                <div className="gelato-card bg-gradient-to-br from-white to-green-50 dark:from-gray-800 dark:to-gray-700 sticky top-6">
    ...
    const renderOrderComplete = () => (
        <div className="text-center">
            <div className="gelato-card max-w-md mx-auto bg-gradient-to-br from-green-50 to-blue-50 dark:from-green-900/30 dark:to-gray-800">
                ...
                <div className="bg-white dark:bg-gray-700 rounded-lg p-4 mb-6">
                    ...
                    <p className="text-gray-600 dark:text-gray-400">Total: ${total.toFixed(2)}</p>
                </div>
        ...
        return (
            <div className="min-h-screen bg-gradient-to-br from-pink-50 via-blue-50 to-yellow-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 relative overflow-hidden transition-colors duration-300">
                <div className="gelato-container relative z-10">
                    <div className="gelato-card text-center bg-gradient-to-br from-white to-blue-50 dark:from-gray-800 dark:to-gray-700 max-w-md mx-auto mt-20">
                        <div className="text-6xl mb-4">🛒</div>
                        <h2 className="text-2xl font-semibold text-gray-700 dark:text-gray-200 mb-4">Your cart is empty!</h2>
                        <p className="text-gray-600 dark:text-gray-400 mb-6">Add some delicious ice cream to your cart before checking out.</p>
