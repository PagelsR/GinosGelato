// Deploy Azure infrastructure for FIFOWorldCup Prediction Hub
...
param costCenter string = 'FIFOWorldCup'
...
var kvSecretFifoApiKey = 'FifoApiKey'
...
module configSettings 'configSettings.bicep' = {
  ...
  params: {
    ...
    fifoApiKeySecretName: kvSecretFifoApiKey
  }
}
